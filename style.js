(function (blink) {
	...
	var PearsonGER_demoStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	PearsonGER_demoStyle.prototype = {
		bodyClassName: 'content_type_clase_PearsonGER_demo',
		toolbar: { name: 'editorial', items: ['Blink_popover'] },
		extraPlugins: ['blink_popover'],
		ckEditorStyles: {
			name: 'PearsonGER_demo',
			styles: [
		...
		formatCarouselindicators: function () {
			...
			$navbarBottom
				.attr('class', 'PearsonGER_demo-navbar')
		...
		animateNavbarOnScroll: function () {
			...
			var $navbar = $('.PearsonGER_demo-navbar');
			var lastScrollTop = 0;
	...
	PearsonGER_demoStyle.prototype = _.extend({}, new blink.theme.styles.basic(), PearsonGER_demoStyle.prototype);

	blink.theme.styles['PearsonGER_demo'] = PearsonGER_demoStyle;
